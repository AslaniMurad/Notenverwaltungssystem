(function () {
  ...
  function open(options) {
    ...
    instance.title.textContent = String(options.title || "Bestätigung");
    instance.message.textContent = String(options.message || "");

    if (options.note) {
      instance.note.hidden = false;
      instance.note.textContent = String(options.note);
    } else {
    ...
    instance.cancel.textContent = String(options.cancelText || "Abbrechen");
    instance.confirm.textContent = String(options.confirmText || "OK");
